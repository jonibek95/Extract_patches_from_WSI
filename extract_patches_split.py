...
def parse_annotation(anno_path, level, mag_factor):
    ...
    for an_i, crds in enumerate(tree.iter(tag='Vertices')):
        # print('Coordinates: ', crds)
        '''
...
#     case_name = slide_.split('/')[-1].split('.')[0]
    # TEA-graph-master/Sample_data_for_demo/Raw_WSI/dataset/dataset_patches

#     prefix_dir = './patch_dataset/data/' + case_name + \
#                  '/level' + str(level) + '/' + current_section + '/'

#     patch_array_dst = './patch_dataset/data/'  + case_name + \
#                       '/level' + str(level) + '/' + current_section + '/patches/' 
    patch_array_dst = './lung_dataset/patches_512/' 

#     patch_coords_dst = './patch_dataset/data/'  + case_name + \
#                        '/level' + str(level) + '/' + current_section + '/'
...
def preprocessingAndanalysis(slide_name, section_list, positivethresh, \
    dataset_dir='./Sample_data_for_demo/Raw_WSI/dataset/dataset_patches/', level_dir='/level1/'):
...
'''
def capextract(slide_name, dataset_dir='./Sample_data_for_demo/Raw_WSI/dataset/dataset_patches/', level_dir='/level1/'):
